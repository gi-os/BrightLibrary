...
**Current version:** `baseVersionName` in `app/build.gradle.kts` is `1.18.0-light.1`.
...
- v1.18 — Volume **down** turns forward now, up turns back, the way every other e-reader
  does it (see [RELEASE_NOTES.md](RELEASE_NOTES.md))
